...
- `create_gift_code(self, code: str, amount: Any, params={})`
...
- `futures_transfer(self, code: str, amount: Any, type: Any, params={})`
...
- `nonce(self)`
- `redeem_gift_code(self, giftcardCode: Any, params={})`
...
- `request(self, path: Any, api='public', method='GET', params={}, headers: Any = None, body: Any = None, config={})`
...
- `get_ws_url(self, type: Any, category: Any)`
...
- `watch_multi_ticker_helper(self, methodName: Any, channelName: Str, symbols: Strings = None, params={}, isUnsubscribe: bool = False)`
...
- `set_balance_cache(self, client: Client, type: Any, isPortfolioMargin=False)`
- `load_balance_snapshot(self, client: Client, messageHash: Any, type: Any, isPortfolioMargin: Any)`
...
- `get_market_type(self, method: Any, market: Any, params={})`
...
- `set_positions_cache(self, client: Client, type: Any, symbols: Strings = None, isPortfolioMargin=False)`
- `load_positions_snapshot(self, client: Client, messageHash: Any, type: Any, isPortfolioMargin: Any)`
