...
- `create_gift_code(self, code: str, amount: object, params: dict = {})`
...
- `fetch_account_positions(self, symbols: Strings = None, params: dict = {})`
- `fetch_adl_rank(self, symbol: str, params: dict = {})`
...
- `fetch_ledger_entry(self, id: str, code: Str = None, params: dict = {})`
...
- `fetch_my_dust_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_open_interest_history(self, symbol: str, timeframe: str = '5m', since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_option_positions(self, symbols: Strings = None, params: dict = {})`
...
- `fetch_positions_risk(self, symbols: Strings = None, params: dict = {})`
...
- `check_no_stock_symbols(self, symbols: Strings, methodName: str)`
- `describe(self)`
- `edit_contract_order_request(self, id: Str, symbol: Str, type: Str, side: Str, amount: Num, price: Num = None, params: dict = {})`
- `edit_contract_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num, price: Num = None, params: dict = {})`
...
- `edit_spot_order_request(self, id: str, symbol: Str, type: Str, side: Str, amount: Num, price: Num = None, params: dict = {})`
- `edit_spot_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num, price: Num = None, params: dict = {})`
- `enable_demo_trading(self, enable: bool)`
- `futures_transfer(self, code: str, amount: object, type: object, params: dict = {})`
...
- `mint_tokenized_asset(self, underlyingAsset: str, underlyingAssetAmount: str, params: dict = {})`
- `modify_margin_helper(self, symbol: str, amount: object, addOrReduce: object, params: dict = {})`
- `nonce(self)`
- `redeem_gift_code(self, giftcardCode: object, params: dict = {})`
- `redeem_tokenized_asset(self, tokenizedAsset: str, tokenizedAssetAmount: str, params: dict = {})`
...
- `request(self, path: object, api='public', method: object = 'GET', params: dict = {}, headers: object = None, body: object = None, config: object = {})`
...
- `tokenized_convert_history(self, since: Int = None, limit: Int = None, params: dict = {})`
- `tokenized_convert_status(self, issuerRequestId: str, convertType: str, params: dict = {})`
- `transfer(self, code: str, amount: float, fromAccount: str, toAccount: str, params: dict = {})`
- `verify_gift_code(self, id: str, params: dict = {})`
...
- `sapi_get_portfolio_margin_call_level(request)`
...
- `sapi_post_portfolio_margin_call_level(request)`
...
- `sapi_delete_portfolio_margin_call_level(request)`
...
- `eapiprivate_post_stock_contract(request)`
...
- `public_get_executionrules(request)`
- `public_get_avgprice(request)`
- `public_get_referenceprice(request)`
- `public_get_referenceprice_calculation(request)`
- `public_get_historicalblocktrades(request)`
...
- `papi_get_um_algo_algoorder(request)`
- `papi_get_um_algo_openalgoorders(request)`
- `papi_get_um_algo_allalgoorders(request)`
...
- `papi_post_um_algo_order(request)`
...
- `papi_delete_um_algo_order(request)`
- `papi_delete_um_algo_allopenorders(request)`
...
- `stream(self, type: Str, subscriptionHash: Str, numSubscriptions: Int = 1)`
...
- `fetch_order_book_ws(self, symbol: str, limit: Int = None, params: dict = {})`
...
- `fetch_ticker_ws(self, symbol: str, params: dict = {})`
- `fetch_ohlcv_ws(self, symbol: str, timeframe: str = '1m', since: Int = None, limit: Int = None, params: dict = {})`
...
- `watch_multi_ticker_helper(self, methodName: object, channelName: Str, symbols: Strings = None, params: dict = {}, isUnsubscribe: bool = False)`
- `sign_params(self, params: dict = {})`
- `ensure_user_data_stream_ws_subscribe_signature(self, marketType: str = 'spot')`
- `ensure_user_data_stream_ws_subscribe_listen_token(self, marketType: str = 'margin', params: dict = {})`
- `renew_listen_token(self, params: dict = {})`
- `authenticate(self, params: dict = {})`
- `keep_alive_listen_key(self, params: dict = {})`
- `set_balance_cache(self, client: Client, type: object, isPortfolioMargin: bool = False)`
- `load_balance_snapshot(self, client: Client, messageHash: object, type: object, isPortfolioMargin: object)`
- `fetch_balance_ws(self, params: dict = {})`
- `fetch_position_ws(self, symbol: str, params: dict = {})`
- `fetch_positions_ws(self, symbols: Strings = None, params: dict = {})`
...
- `get_market_type(self, method: object, market: object, params: dict = {})`
...
- `fetch_orders_ws(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
...
- `set_positions_cache(self, client: Client, type: object, symbols: Strings = None, isPortfolioMargin: bool = False)`
- `load_positions_snapshot(self, client: Client, messageHash: object, type: object, isPortfolioMargin: object)`
- `fetch_my_trades_ws(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_trades_ws(self, symbol: str, since: Int = None, limit: Int = None, params: dict = {})`
